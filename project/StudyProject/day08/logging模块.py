...
fh = logging.FileHandler(filename='xxx1.log',encoding='utf-8')        #写到文件上
fh1 =logging.handlers.RotatingFileHandler('myapp3.log',maxBytes=512,backupCount=5,encoding='utf-8')    #RotatingFileHandler 根据大小切割文件
fh2 =logging.handlers.TimedRotatingFileHandler(filename='myapp4.log',when='H',interval=5,encoding='utf-8')  #TimedRotatingFileHandler根据时间切割
